...
sed 's/plugins=(git)/plugins=(autojump git zsh-syntax-highlighting zsh-autosuggestions)/g' /home/$username/.zshrc >/home/$username/.zshrc.bak && mv /home/$username/.zshrc.bak /home/$username/.zshrc 
